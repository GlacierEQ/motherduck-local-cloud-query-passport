"""Executable near/far impact assurance for Local-Cloud Query Passport."""
from dataclasses import asdict,dataclass
from math import isfinite
from typing import Iterable
REPOSITORY="motherduck-local-cloud-query-passport"; COMPANY_LENS="MotherDuck"; INNOVATION="Local-Cloud Query Passport"
